...
# LinkMates VPS Setup Script
# This script helps set up LinkMates on a fresh Ubuntu/Debian VPS

# Exit on error
set -e

echo "=== LinkMates VPS Setup Script ==="
...
sudo ln -sf /etc/nginx/sites-available/peerlink /etc/nginx/sites-enabled/LinkMates
